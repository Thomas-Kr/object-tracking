...
from object_tracking_huateng import Tracker
...
def connect():
    ...
    mvsdk.CameraSetFrameSpeed(hCamera, 10)
...
if __name__ == "__main__":
    hCamera, cap = connect()
    tracker = Tracker(get_frame(hCamera, cap))

    while True:
        frame = tracker.track(get_frame(hCamera, cap), 0.95)
